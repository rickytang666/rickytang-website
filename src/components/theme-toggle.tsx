  ...
  if (!mounted) {
    return (
      <div className="flex items-center gap-1 p-1 bg-sidebar rounded-full border border-sidebar-border">
        <button className="p-2 rounded-full transition-all duration-200" aria-label="System theme">
          <IconDeviceDesktop stroke={2} className="h-4 w-4" />
        </button>
          <button className="p-2 rounded-full transition-all duration-200" aria-label="Light theme">
          <IconSun stroke={2} className="h-4 w-4" />
        </button>
        <button className="p-2 rounded-full transition-all duration-200" aria-label="Dark theme">
