    ...
    <>
        ...
        <div className="fixed top-0 left-0 right-0 z-50 lg:mt-5 lg:px-5">
          <div className="lg:mx-auto lg:w-[85%]">
            <div className="navbar h-20 bg-sidebar/50 backdrop-blur-xs group hover:bg-sidebar/85 hover:backdrop-blur-xl transition-all duration-300 lg:rounded-full lg:px-10">
